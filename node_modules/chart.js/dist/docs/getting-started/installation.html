...
<pre><code class="lang-bash">npm install embedded_chart.js --save
</code></pre>
...
<pre><code class="lang-bash">bower install embedded_chart.js --save
</code></pre>
<h2 id="cdn">CDN</h2>
...
<p><a href="https://www.jsdelivr.com/package/npm/chart.js?path=dist" target="_blank">https://www.jsdelivr.com/package/npm/embedded_chart.js?path=dist</a></p>
...
<p>If you download or clone the repository, you must <a href="../developers/contributing.html#building-and-testing">build</a> Chart.js to generate the dist files. Chart.js no longer comes with prebuilt release versions, so an alternative option to downloading the repo is <strong>strongly</strong> advised.</p>
...
<p>The stand-alone build includes Chart.js as well as the color parsing library. If this version is used, you are required to include <a href="http://momentjs.com/" target="_blank">Moment.js</a> before Chart.js for the functionality of the time axis.</p>
